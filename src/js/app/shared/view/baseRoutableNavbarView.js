define([
    ...
    var BaseRoutableNavbarView = function(options) {
        this.inheritedEvents = [];
        this.attributes = {};
        Backbone.View.call(this, options);
    };

    _.extend(BaseRoutableNavbarView.prototype, Backbone.View.prototype, {
    ...
    BaseRoutableNavbarView.extend = Backbone.View.extend;
    //
